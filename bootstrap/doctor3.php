...
<body>
    ...
    <div class="container-fluid" style="border-top:3px solid #00A950; border-bottom:10px solid #00A950;">
        ...
        <div class="container">
            ...
            <div class="col-md-5">
                <p>
                     Dr. Raja Dhar,<br> MD, MRCP (UK), CCT (UK), FCCP (USA), M Sc<br> (Evidence Based Medicine, UK), Diploma in <br>Palliative Care for Physicians (Teeside<br> University, UK), Certificate in Medical <br>Education  (Newcastle University, UK) 
